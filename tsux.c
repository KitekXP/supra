...
int print_help() {
	printf("TsUX\n\n");
	printf("Usage\n");
	printf("   tsux <userid> <command> [args]\n");
	printf("\n");
	printf("\n");
	printf("\n");
	printf("\n");
...
int get_priviliges(int uid) {
	...
	if (errcode != 0) {
		...
		printf("ERROR:   chown root:root /location/of/tsux\n");
		printf("ERROR:   chmod 4111 /location/of/tsux\n");
...
int main(int argc, char ** argv) {
	...
	if (!uid_allow_check(getuid())) { printf("ERROR: user id not in /etc/tsux.allow\n"); return 1; }
